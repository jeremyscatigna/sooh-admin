  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 bg-slate-200">
        ...
        {/* Close button */}
        <div className="absolute top-4 left-4 sm:left-6 text-white opacity-80 hover:opacity-100">
            <Link className="btn-sm px-3 bg-white border-slate-200 hover:border-slate-300 text-slate-600" to="/community/users-tabs">
