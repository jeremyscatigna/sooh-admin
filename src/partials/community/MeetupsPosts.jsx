        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            ...
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">Le Dylano</h3>
            </Link>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-indigo-500 uppercase mb-2">Mon 27 Dec, 2021</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">Sandrine Coiffure</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            ...
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">Di piu</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-indigo-500 uppercase mb-2">Wed 29 Dec, 2021</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">Jean Michel Socca</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            ...
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">Le garage de Jacquie</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            ...
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">La Boucherie du Village</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-indigo-500 uppercase mb-2">Thu 6 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">Fruits et Legumes du Village</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            ...
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800">O'McAllister Pub</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
