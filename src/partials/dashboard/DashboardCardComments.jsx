  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-card shadow-lg rounded-xl">
      <div className="px-4 pt-4 flex justify-between">
        ...
        <div className="text-xs font-semibold text-secondary mb-1">Nombre de commentaires</div>
        </div>
        <div className="flex items-center justify-center pb-4">
          <div className="text-5xl font-bold text-primary mr-2 mt-4">{comments}</div>
        </div>
      </div>
    </div>
  );
