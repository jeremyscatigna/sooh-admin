...
function UpdateHappyHour() {
    ...
    const [happyHourId, setHappyHourId] = useState(null);
    ...
    useEffect(() => {
        const getHappyHour = async () => {
            ...
            const happyhours = await getDocs(collectionQuery);

            const happyHourData = happyhours.docs.map((doc) => ({ id: doc.id, ...doc.data() }))[0];

            console.log(happyHourData);

            setName(happyHourData.name);
            setDescription(happyHourData.description);
            setDetails(happyHourData.details);
            setRecurency(happyHourData.recurency);
            setCategory(happyHourData.category);
            setType(happyHourData.type);
            setDeal(happyHourData.deal);
            setLocation(happyHourData.location);
            setCity(happyHourData.city);
            setClosedDays(happyHourData.closedDays);
            setSelectedDates(happyHourData.date);
            setEndTime(happyHourData.endTime);
            setEndDate(happyHourData.endDate);
            setImgUrl(happyHourData.imageUrl);

            setHappyHourId(happyHourData.id);
        };
    ...
    const handleCreate = async () => {
        ...
        console.log(toAdd);
        const hhRef = doc(db, 'happyhours', happyHourId);
        try {
...
export default UpdateHappyHour;
