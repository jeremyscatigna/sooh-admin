...
function SvgNumber0Square(passedProps, svgRef) {
    ...
    return (React.createElement("svg", __assign({ width: "1.5em", height: "1.5em", viewBox: "0 0 24 24", strokeWidth: 1.5, fill: "none", xmlns: "http://www.w3.org/2000/svg", color: "currentColor", ref: svgRef }, props),
        ...
        React.createElement("path", { d: "M9.5 14v-4a2 2 0 012-2h1a2 2 0 012 2v4a2 2 0 01-2 2h-1a2 2 0 01-2-2z", stroke: "currentColor" })));
}
var ForwardRef = React.forwardRef(SvgNumber0Square);
